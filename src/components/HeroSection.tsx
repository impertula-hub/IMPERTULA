...
export function HeroSection({ onViewProducts, onContact }: HeroSectionProps) {
  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-start md:items-center pt-28 pb-16 md:pt-0 md:pb-0">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="mb-4 md:mb-6">
            ...
            <motion.p 
              className="text-base md:text-xl text-gray-200 mb-5 md:mb-8 leading-relaxed"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
